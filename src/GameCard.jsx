...
const GameCard = ({ game }) => {
  return (
    <div className="transi relative min-h-48 hover:scale-105">
      <img
        className="block h-full w-full rounded-lg border-2 border-solid border-black"
        src={game.background_image}
        alt={game.name + "background image"}
      />
        <div className="absolute h-[84px] w-full -translate-y-full bg-gradient-to-r from-gray-700 via-gray-900 to-black  opacity-95"></div>
